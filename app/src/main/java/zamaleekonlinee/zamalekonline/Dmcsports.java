 ...
 */
public class Dmcsports  extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener{
    private static final int RECOVERY_DIALOG_REQUEST = 1;
    static    String DEVELOPER_KEY="AIzaSyAiHRah9SmXG5Kyb7qeNauQyi-4XQ8HT50";
    private YouTubePlayerView youTubePlayer;
    private static String YOUTUBE_VIDEO_CODE="-ArVVjULs38";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dmcsport);

        youTubePlayer = (YouTubePlayerView) findViewById(R.id.IDdmcsport);
    ...
    public void onInitializationSuccess(YouTubePlayer.Provider provider, YouTubePlayer youTubePlayer, boolean b) {
        if (!b) {
            ...
            youTubePlayer.loadVideo(Dmcsports.YOUTUBE_VIDEO_CODE);
            youTubePlayer.cueVideo(Dmcsports.YOUTUBE_VIDEO_CODE);
